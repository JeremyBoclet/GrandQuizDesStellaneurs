...
class Round:
    ...
    def add_round2_button(self):
        ...
        self.group_buttons_round2.add(Button("Button_template2", 350, 910, 550, 110))

        self.group_buttons_round2.add(Button("Button_template2", 1000, 250, 550, 110))
        self.group_buttons_round2.add(Button("History", 1000, 360, 550, 110))
        self.group_buttons_round2.add(Button("Button_template2", 1000, 470, 550, 110))
